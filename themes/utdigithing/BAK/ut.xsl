   ...
   <xsl:output indent="yes"/>
    ...
    <xsl:template name="buildFooter">
        ...
        <div id="ds-footer">
            ...
            <!--<div id="ds-footer-logo"><a href="#"></a></div>-->
            <div id="ds-footer-links">
                <p>
                    ...
                    <a 
href="http://www.lib.utexas.edu/comments.html?referrer=http://repositories.lib.utexas.edu">Comments</a> | <a 
                        href="http://www.lib.utexas.edu/about/site.html">About This
                        Site</a> | <a href="http://www.utexas.edu/emergency/">Emergency Preparedness, Safety and 
Security</a><a href="/htmlmap"><xsl:text> </xsl:text></a></p>
...
<xsl:template match="/dri:document/dri:body/dri:div[@n='news']">
	<p>
	The Repository's purpose is to collect, record, provide access 
	to, and archive the scholarly and research works of the University of Texas 
	at Austin, as well as works that reflect the intellectual and service 
...
<xsl:template match="/dri:document/dri:body/dri:div[2][@n='comunity-browser']">
	...
	<div class="headwrapper-left-crn"><xsl:text> </xsl:text></div>
	<h1>
	<div class="ds-div-head">Recent Submissions</div>
	</h1>
	</div>
	<div class="headerwrapper-bt"><xsl:text> </xsl:text></div>
