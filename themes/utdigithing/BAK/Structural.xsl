...
<xsl:stylesheet xmlns:i18n="http://apache.org/cocoon/i18n/2.1"
    ...
    <xsl:output indent="yes"/>
	 ...
	 <xsl:template match="dri:options">
		...
		<ul>    
                    <li><a style="color:#C50;" href="https://surveystation.austin.utexas.edu//TakeSurvey.aspx?SurveyID=ll0J5nl5">
                        Tell us your opinions about the UT Digital Repository-take this short survey!</a></li>
                </ul> 
            </div>
...
<!-- Curator Training -->
   <xsl:template match="dri:options/dri:list[@n='context']/dri:head">
        ...
        <ul class="ds-options-list">
        <li>
        <h4 class="ds-sublist-head">Curator Training</h4>
        <ul class="ds-simple-list">
        <li><a href="/themes/utdigithing/inc/manual.pdf">Manual (pdf)</a></li>
        </ul>
        </li>
        </ul>
        </div>
