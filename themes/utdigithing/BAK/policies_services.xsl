    ...
    <xsl:template name="policies_servicesBody">
		...
		<div class="headwrapper-left-crn"><xsl:text> </xsl:text> </div>
			...
			<div class="headerwrapper-bt"><xsl:text> </xsl:text></div>
                    ...
                    <ol start="1" type="1">
                        <li>UT Digital Repository’s purpose is to collect, record, provide access to, and archive the digital works of the University of Texas at Austin.  UT Digital Repository will include       research and scholarship, as well as works that reflect the intellectual       and service environment of the campus.</li>
                    </ol>
                    
                    <ol start="2" type="1">
                        <li><p>UT Digital Repository will adhere to  <a href="http://www.utexas.edu/policies/privacy/">UT’s Web Privacy Policy</a>,  and to the security standards for  <a href="http://www.utexas.edu/its/policies/opsmanual/secstd.php">Category II-Data</a>. </p> 
...
I Data</a>.</p>
                    ...
                    <ol start="5" type="1">
                        <li><p><strong><a name="submission_services" id="submission_services"></a>Submission Services to Established Collections</strong></p>
                            <p>UT  Digital Repository offers an easy-to-use web based process for submitting digital  works one by one to an established Collection.   Once authorized to do so, UT faculty, staff, students, colleges,  departments, research centers, administrative and other campus groups can submit  their works to the appropriate Collections.   See the <a href="/policies_submission">Submission and Withdrawal Policy</a> for submission  guidelines and the <a href="/help">Help</a> section for step-by-step instructions.  </p>
                            <p>A  batch submission service of numerous works to a single Collection by UT  Libraries staff is available.  This  service will be scheduled according to staff work load.  Please contact the Repository Curator, Uri  Kolodney, at <a href="mailto:utdr-collections@utlists.utexas.edu">utdr-collections@utlists.utexas.edu</a> for additional information on the batch submission service.</p>
                        </li>
                    </ol>
                    <br clear="all" />
                    <ol start="6" type="1">
