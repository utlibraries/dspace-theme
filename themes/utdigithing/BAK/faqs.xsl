...
<blockquote>
    ...
    <u><a href="#howdifferent">How is the UT Digital Repository different from posting research on my own  web site?</a></u><br />
...
<blockquote>
    ...
    <u><a href="#depart_setup">How does my department or research unit set up its own collection?</a></u>
</blockquote></p>
...
<ol start="3" type="1">
  <li><strong> <a name="whocansearch" id="whocansearch"></a>Who </strong><strong>can search, browse, and       download from the UT       Digital Repository?</strong></li>
                    ...
                    <p>The Repository is designed to provide your work the widest  possible exposure, so it is open to the world for searching. You may, however,  choose to submit your work but prevent it from being seen in full for a limited  time.  Please see question #30:  <u>“<em><a href="#restrict_access">Can I restrict access to the work I submit  to the UT Digital Repository?</a></em>”</u> for more information on restricting  access to your work. </p>
<ol start="4" type="1">
  <li><strong><a name="whocansubmit" id="whocansubmit"></a>Who can submit works to       the UT Digital Repository? </strong></li>
</ol>
                    <p>UT faculty, staff, and students (including student groups)  may submit work to the Repository.   Student work must be sponsored by a UT faculty member, and the name of  the sponsoring faculty will appear in the descriptive information associated  with the work. All faculty, staff, and students need authorization from the  <a href="/glossary#repository-curator">Repository Curator</a> before submitting work to the Repository. To get started,  please contact Uri Kolodney, Repository Curator, at <a href="mailto:utdr-collections@utlists.utexas.edu">utdr-collections@utlists.utexas.edu</a></p>
<ol start="5" type="1">
...
<ul>
  <li>Dissemination:  The Repository provides high visibility and increased access to your research  by furnishing descriptive information about your submitted works to Google and <a href="http://scholar.google.com/" target="_top">Google Scholar</a>, <a href="/glossary#oaister">OAIster</a>, and  other services.</li>
  ...
  <li>Persistence:  The Repository provides a permanent web address for your work. </li>
...
<table border="0"  cellspacing="0" cellpadding="0" width="434">
  ...
  <tr>
    <td width="267" valign="top"><p>Open access to works</p></td>
    <td width="80" valign="top"><p><img src="/themes/utdigithing/images/check.png" alt="checked" /></p></td>
    <td width="87" valign="top"><p><img src="/themes/utdigithing/images/not-check.png" alt="not checked" /></p></td>
  </tr>
  <tr>
...
<p>If you are trying to access the UT Digital Repository and it  is not responding, please contact Uri Kolodney, Repository Curator, at <a href="mailto:utdr-collections@utlists.utexas.edu">utdr-collections@utlists.utexas.edu</a> to report the problem.</p>
<ol start="13" type="1">
...
<p>If you are experiencing this or another issue with embedded video in the UT Digital Repository please contact Uri, Kolodney, Repository Curator, at  <a href="mailto:utdr-collections@utlists.utexas.edu">utdr-collections@utlists.utexas.edu</a> to report the problem.  We will help you as we can, or put you in touch with the person who submitted the video.</p>
<br /><br /><p><strong><u><a name="getting_started" id="getting_started"></a>Getting Started</u></strong></p>
<ol start="14" type="1">
  <li><strong><a name="gainauthorization" id="gainauthorization"></a>How do I submit my work  to the UT Digital Repository?</strong></li>
</ol>
<p>You should find the process of submitting to the UT Digital  Repository quick and easy:  </p>
<ul type="disc">
  <li>obtain authorization (see question #14:  <em><u>“<a href="#gainauthorization">How  do I gain authorization to submit to the UT Digital Repository?</a>”</u> </em>for  more information);</li>
...
<ol start="15" type="1">
  <li><strong><a name="gainauthorization_submit" id="gainauthorization_submit"></a>How do I gain authorization to submit to the UT Digital Repository?  </strong></li>
</ol>
<p>For UT faculty and staff, the first step is to identify the  collection you would like to submit to within the <a href="http://repositories.lib.utexas.edu/community-list">Repository</a>.   Next, email Uri Kolodney, Repository  Curator, at <a href="mailto:utdr-collections@utlists.utexas.edu">utdr-collections@utlists.utexas.edu</a>  to request authorization to submit your work  (please include your full name and the name of the collection for which you are  requesting authorization).   <br />
  Departments or  research centers on campus wishing to establish and manage their own collections  may do so by contacting Amy Rushing at <a href="mailto:utdr-general@utlists.utexas.edu">utdr-general@utlists.utexas.edu</a>  to begin the process.<br />
  Students wishing to  submit must first obtain a faculty sponsor. Once faculty sponsorship has been  obtained, contact the Repository Curator at <a href="mailto:utdr-collections@utlists.utexas.edu">utdr-collections@utlists.utexas.edu</a> for authorization.</p>
<ol start="16" type="1">
...
<p>If your department or research unit wants to establish and  manage a collection, we are happy to work with you to set up access,  membership, and other parameters. Each collection will have one or more  curators who will help define specific procedures and guidelines. The  <a href="/glossary#collection-curator">Collection Curator</a> should be a faculty or staff member from the department or  research unit. For more information about collection responsibilities, see the <a href="policies_collections">Collections  Policy</a>. To get started, please contact Amy Rushing at <a href="mailto:utdr-general@utlists.utexas.edu">utdr-general@utlists.utexas.edu</a>.</p>
...
<p>Submission of any single file larger than 512 MB may require  the assistance of the <a href="/glossary#repository-curator">Repository Curator</a>.   Please contact Uri Kolodney, Repository Curator, at <a href="mailto:utdr-collections@utlists.utexas.edu">utdr-collections@utlists.utexas.edu</a> if you plan to submit files larger than 512 MB.  </p>
<ol start="24" type="1">
...
<p>There is no limit on the number of files you may  submit.  Should you have more than 500  files for submission, please contact Uri Kolodney, Repository Curator, at <a href="mailto:utdr-collections@utlists.utexas.edu">utdr-collections@utlists.utexas.edu</a> to request a batch load. </p>
<ol start="25" type="1">
...
<ol start="26" type="1">
  <li><a name="whatrights" id="whatrights"><strong>What       rights do I grant The University of Texas at Austin when I submit my work in the UT Digital Repository?</strong></a></li>
                    ...
                    <p>When you agree to our standard <u>Distribution License</u> you  grant the Repository the <a href="/glossary#non-exclusive">non-exclusive</a>  right to:</p>
<ul>
...
<ol start="28" type="1">
  <li><a name="nolonger_hold_copyright" id="nolonger_hold_copyright"></a><strong>If I no longer hold the       copyright to an article or other publication, can I still submit it to the       UT Digital Repository? </strong></li>
                    ...
                    <p>You may ask your publisher whether you can submit your  previously published work into the Repository. Initially when you publish  you may negotiate with the publisher to retain the right to submit your work to  the Repository by using the <a href="http://www.arl.org/sparc/author/Access-Reuse_addendum_HTML.shtml" target="_top">SPARC Author Addendum</a> or by directly modifying the  publisher’s license. SPARC offers other useful resources for authors as  well (see <a href="http://www.arl.org/sparc/resources/copy.html" target="_top">http://www.arl.org/sparc/resources/copy.html</a>). Please see the <a href="/policies_copyright">Copyright  and Licensing Policy </a> for more information.</p>
<ol start="29" type="1">
...
<p>Revisions to electronic theses or dissertations are not accepted; see FAQ #35.  </p>
<ol start="33" type="1">
...
<ol start="34" type="1">
  <li><strong><a name="privacy_policy" id="privacy_policy"></a>What privacy policies       are in place for the UT Digital Repository? </strong></li>
                    ...
                    <p>The UT Digital Repository adheres to  <a href="http://www.utexas.edu/policies/privacy">UT’s Web Privacy Policy</a> and to the security standards for  <a href="http://www.utexas.edu/its/policies/opsmanual/secstd.php">Category II data</a>.  </p>
...
<p>
Graduating doctoral students at The University of Texas at Austin, beginning with the summer semester of 2001, are required to publish an electronic copy of their dissertation.  Master's students are not currently required to publish their theses electronically.  The UT Digital Repository accepts deposits of Theses and Dissertations from the Office of Graduate Studies at UT Austin.  These digital documents and their metadata are exposed to Google and other search engines upon deposit so they can be available to the world for viewing and downloading.  
</p>
...
Victoria E. Rodríguez, <br />
Vice Provost and Dean of Graduate Studies<br />
