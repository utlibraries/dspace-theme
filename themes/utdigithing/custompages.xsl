...
<xsl:stylesheet xmlns:i18n="http://apache.org/cocoon/i18n/2.1"
    ...
    <xsl:template name="customBody">
	 ...
	 <!-- Check for the custom pages -->
       <xsl:when test="/dri:document/dri:meta/dri:pageMeta/dri:metadata[@element='request'][@qualifier='URI']='ldap-login'">
         <!-- custom content for url 'login' -->
         		<div class="headwrapper">
			<div class="headwrapper-left-crn"><xsl:text> </xsl:text> </div>
			...
			<div class="headerwrapper-bt"><xsl:text> </xsl:text></div>
			<form id="aspect_eperson_LDAPLogin_div_login" class="ds-interactive-div primary" action="/ldap-login" method="post" onsubmit="javascript:tSubmit(this);" style="width:100%;">
<fieldset id="aspect_eperson_LDAPLogin_list_ldap-login" class="ds-form-list" style="margin:0 0 0 0;">
<ol>
<li class="ds-form-item">
<label class="ds-form-label" for="aspect_eperson_LDAPLogin_field_username">EID:</label>

<div class="ds-form-content">
<input id="aspect_eperson_LDAPLogin_field_username" class="ds-text-field" name="username" type="text" value="" />
</div>
</li>
<li class="ds-form-item">
<label class="ds-form-label" for="aspect_eperson_LDAPLogin_field_ldap_password">Password:</label>
<div class="ds-form-content">
<input id="aspect_eperson_LDAPLogin_field_ldap_password" class="ds-password-field" name="ldap_password" type="password" value="" />
</div>
</li>
<li id="aspect_eperson_LDAPLogin_item_login-in" class="ds-form-item last">
<label class="ds-form-label" for="aspect_eperson_LDAPLogin_field_submit"> 
		                </label>
<div class="ds-form-content">
<input id="aspect_eperson_LDAPLogin_field_submit" class="ds-button-field" name="submit" type="submit" value="Sign in" />
</div>
       ...
       <xsl:when test="/dri:document/dri:meta/dri:pageMeta/dri:metadata[@element='request'][@qualifier='URI']='password-login'">
         <!-- custom content for url 'login' -->
			...
			<div class="headerwrapper-bt"><xsl:text> </xsl:text></div>
			<form id="aspect_eperson_PasswordLogin_div_login" class="ds-interactive-div primary" action="/password-login" method="post" onsubmit="javascript:tSubmit(this);" style="width:100%">
			<fieldset id="aspect_eperson_PasswordLogin_list_password-login" class="ds-form-list" style="margin:0 0 0 0;">
			<ol>
			<li class="ds-form-item">
