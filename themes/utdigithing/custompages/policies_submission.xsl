    ...
    <xsl:template name="policies_submissionBody">
		 ...
		 <div class="headwrapper">
			...
			<div class="headerwrapper-bt"><xsl:text> </xsl:text></div>
                    ...
                    <ol start="9" type="1">
                        <li> 
Requests for withdrawing works (except dissertations) must be directed to the Collection and UT Digital <a href="/glossary#repository-curator">Repository Curators</a>. After review of the request,  <a href="/glossary#collection-curator">Collection Curator(s)</a> will contact the requestor to let him/her know a work has been withdrawn, or, if withdrawal is not appropriate, to let the requestor know the reason(s) withdrawal was not completed. Requests for withdrawing dissertations must be directed to the Office of Graduate Studies. See <a href="/faqs#theses_removal">FAQ number 36</a> for more information.
</li>
                    </ol>
                    <ol start="10" type="1">
