...
<ol start="3" type="1">
  <li><strong> <a name="whocansearch" id="whocansearch"></a>Who </strong><strong>can search, browse, and download from the UT       Digital Repository?</strong></li>
                    ...
                    <p>The Repository is designed to provide your work the widest  possible exposure, so it is open to the world for searching. You may, however,  choose to submit your work but prevent it from being seen in full for a limited  time.  Please see question #32:  <u>“<em><a href="#restrict_access">Can I restrict access to the work I submit to the UT Digital Repository?</a></em>”</u> for more information on restricting  access to your work. </p>
<ol start="4" type="1">
...
Departments or research centers on campus wishing to establish and manage their own collections may do so by contacting Colleen Lyon at a <a href="mailto:utdr-general@utlists.utexas.edu">utdr-general@utlists.utexas.edu</a> to begin the process.
</p>
<p>
...
<p>Access to electronic dissertations are open in accordance with the policies of the Office of Graduate Studies; see FAQ #36.  </p>
...
<p>Revisions to electronic theses or dissertations are not accepted; see FAQ #37.  </p>
<ol start="34" type="1">
...
<p>
Graduating doctoral students at The University of Texas at Austin, beginning with the summer semester of 2001, are required to publish an electronic copy of their dissertation.  
Beginning with the fall semester of 2010, master's theses and reports must also be published electronically. The UT Digital Repository accepts deposits of 
Theses and Dissertations from the Office of Graduate Studies at UT Austin.  These digital documents and their metadata are exposed to Google and other search engines upon deposit so they can be available to the world for viewing and downloading.  
</p>
